  ...
  <el-container style="height: 550px; border: 1px solid #eee">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      <el-menu :default-openeds="['1','3']"
        ...
        @select="handleSelect">
        <el-submenu index="1">
          <template slot="title"><i class="el-icon-setting"></i>训练设置</template>
          <el-menu-item-group>
            <template slot="title">我的进程</template>
            <el-menu-item index="1-1"><i class="el-icon-folder-add"></i>新建进程</el-menu-item>
            <el-menu-item index="1-2"><i class="el-icon-s-data"></i>历史数据</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        ...
        <el-submenu index="3">
          <template slot="title"><i class="el-icon-s-marketing"></i>显示图表</template>
          <el-menu-item-group>
    ...
    <el-container>
      ...
      <el-main v-show='panel==="parameter"'>
        ...
        <el-form id="paras" :ref="paras" :model="paras" label-width="80px">
          ...
          <el-form-item label="训练步数">
            <el-input-number v-model="paras.steps" :step="1000"></el-input-number>
          </el-form-item>
          <el-form-item label="上传数据">
            ...
            >
              ...
              <div class="el-upload__tip" slot="tip">只能上传.db文件，且不超过10MB</div>
            </el-upload>
          </el-form-item>
          <el-form-item>
            <el-button type="primary" @click="createProcess" :disabled="processSwitch">创建任务</el-button>
      ...
      <el-main v-show='panel==="historyData"'>
        <el-table :data="processTableData">
          ...
          <el-table-column prop="steps" label="训练步数">
          </el-table-column>
...
export default {
  ...
  methods:{
    ...
    train:function () {
      ...
      xmlhttp.open('GET','http://localhost:8082/process/runProcess?&processId='+processId,true);
    ...
    createProcess:function () {
      ...
      xmlhttp.open('POST','http://localhost:8082/process/createProcess',false);
      xmlhttp.setRequestHeader("Content-type", "application/json; charset=utf-8");
    ...
    searchProcessId:function () {
      ...
      xmlhttp.open('GET','http://localhost:8082/process/searchProcess?&userId='+userId,false);
      xmlhttp.setRequestHeader("Content-type", "application/json; charset=utf-8");
      xmlhttp.send();
    },
    ...
    drawPropertyChart:function () {
      ...
      xmlhttp.open('GET','http://localhost:8082/chart/getPropertyData?&processId='+processId,false);
      xmlhttp.setRequestHeader("Content-type", "application/json; charset=utf-8");
      xmlhttp.send();
    ...
    drawRateChart:function () {
      ...
      xmlhttp.open('GET','http://localhost:8082/chart/getRateData?&processId='+processId,false);
      xmlhttp.setRequestHeader("Content-type", "application/json; charset=utf-8");
      xmlhttp.send();
